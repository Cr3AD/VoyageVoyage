...
//
//   let placeDetailDataJSON = try? newJSONDecoder().decode(PlaceDetailDataJSON.self, from: jsonData)

import Foundation

// MARK: - PlaceDetailDataJSON
struct PlaceDetailDataJSON: Codable {
...
// MARK: - PlaceDetailAddressComponent
